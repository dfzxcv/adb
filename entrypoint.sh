...
UUID=${UUID:-'c7e938b1-ac11-47e8-a46b-aaf76280ed65'}
VMESS_WSPATH=${VMESS_WSPATH:-'/c7e938b1-ac11-47e8-a46b-aaf76280ed65-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/c7e938b1-ac11-47e8-a46b-aaf76280ed65-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/c7e938b1-ac11-47e8-a46b-aaf76280ed65-trojan'}
